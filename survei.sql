--
-- Database: `db_survei`
-- Host: 172.16.30.33    Database: db_survei
...
CREATE DATABASE IF NOT EXISTS `db_survei` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `db_survei`;
...
DROP TABLE IF EXISTS `jawaban_responden`;
...
CREATE TABLE `survei` (
  ...
  `file` varchar(255) DEFAULT NULL COMMENT 'Path/URL logo untuk survei',
  `status` tinyint(1) DEFAULT 1,
  `user_input` varchar(100) DEFAULT NULL,
  `tanggal_input` datetime DEFAULT NULL,
  `user_update` varchar(100) DEFAULT NULL,
...
INSERT INTO `survei` (`id`, `judul`, `deskripsi`, `tanggal_mulai`, `tanggal_selesai`, `status_publikasi`, `file`, `status`, `user_input`, `tanggal_input`, `user_update`, `tanggal_update`) VALUES
(1, 'tes B', 'Kepuasan pelanggan sebagai faktor penting utama yang menentukan apakah suatu bisnis atau perusahaan berhasil memberikan pelayanan yang baik kepada para pelanggan mereka', '2025-10-13', '2025-11-30', 'draft', NULL, 9, 'ahmad.riyadi', '2025-10-13 16:34:32', 'ahmad.riyadi', '2025-10-16 14:10:38'),
(2, 'Survei Kepuasan Pelanggan', 'Pertanyaan survei kepuasan pelanggan dapat mencakup penilaian umum terhadap produk atau layanan, kepuasan terhadap interaksi layanan pelanggan, kemudahan penggunaan, dan kemungkinan merekomendasikan (NPS)', '2025-10-13', '2025-10-31', 'selesai', NULL, 9, 'ahmad.riyadi', '2025-10-13 17:22:03', 'ahmad.riyadi', '2025-10-16 14:10:34'),
(3, 'test', 'testing aja', '2025-10-15', '2025-10-15', 'draft', NULL, 9, 'ahmad.riyadi', '2025-10-15 15:55:21', 'ahmad.riyadi', '2025-10-16 10:47:17'),
(4, 'Efisiensi Penggunaan Pembayaran Digital dibandingkan Tunai', 'Survei ini bertujuan untuk mengetahui tingkat efisiensi penggunaan pembayaran digital dibandingkan dengan transaksi tunai dalam kegiatan sehari-hari. Melalui survei ini, kami ingin memahami persepsi, kebiasaan, serta pengalaman masyarakat dalam menggunakan berbagai metode pembayaran seperti e-wallet, mobile banking, atau kartu debit/kredit.\r\nHasil survei ini akan digunakan untuk menilai sejauh mana pembayaran digital dapat meningkatkan kecepatan, kemudahan, dan keamanan transaksi dibandingkan dengan pembayaran tunai, serta faktor-faktor apa saja yang mempengaruhi preferensi pengguna.', '2025-10-16', '2025-12-16', 'draft', 'image/bkd.jpeg', 1, 'ahmad.riyadi', '2025-10-16 10:49:25', 'ahmad.riyadi', '2025-10-16 10:49:25'),
(5, 'Dampak Penggunaan Media Sosial terhadap Produktivitas dan Kesehatan Mental ', 'Survei ini bertujuan untuk mengetahui bagaimana penggunaan media sosial memengaruhi produktivitas dan kesehatan mental individu. Melalui survei ini, kami ingin memahami sejauh mana media sosial berperan dalam meningkatkan atau justru menurunkan fokus, motivasi, serta kesejahteraan psikologis pengguna. Hasil survei ini diharapkan dapat memberikan gambaran tentang dampak positif maupun negatif dari media sosial, sekaligus menjadi dasar untuk mendorong kebiasaan digital yang lebih sehat dan seimbang.', '2025-10-16', '2025-10-16', 'draft', NULL, 1, 'ahmad.riyadi', '2025-10-16 12:05:11', 'ahmad.riyadi', '2025-10-16 12:05:11'),
(6, 'tes tes tes', 'testes1tesa a afasdfa asfdasdfasdfasdfasdfasfa afadfasdfa af asdfasdfa', '2025-10-21', '2025-10-31', 'draft', NULL, 9, 'ahmad.riyadi', '2025-10-21 09:24:28', 'ahmad.riyadi', '2025-10-21 10:39:31');
...
(1, 'd766cd8f863a59b68a9e41f3237be273e7b82a512ee0cc104e92aa070836d9cd', 4, 1, '2025-10-14 13:46:14', NULL, NULL, 'terdaftar', 0.00, 1, 'ahmad.riyadi', '2025-10
'2025-10-17 13:27:05', NULL, NULL, 'terdaftar', 0.00, 1, 'ahmad.riyadi', '2025-10-17 13:27:05', NULL, NULL),
(25, '14cceeed5ac2ff8115b774b6e40bdae6406f088a1ba1c10a3d973ca3a0a20201', 4, 22, '2025-10-17 13:27:05', NULL, NULL, 'terdaftar', 0.00, 1, 'ahmad.riyadi', '2025-10-17 13:27:05', NULL, NULL),
...
(48, 'a4ed9deef74394ca91f3139282afe1225d5815d2f5afc52c70e7d050dd9e89dd', 4, 1, '2025-10-21 09:26:55', NULL, NULL, 'terdaftar', 0.00, 1, 'ahmad.riyadi', '2025-10-21 09:26:55', NULL, NULL),
(49, '5d13c910292d2dc1d14bfe511aab6a2a86634775653f997bf944e4b5401901a9', 4, 2, '2025-10-21 09:26:55', NULL, NULL, 'terdaftar', 0.00, 1, 'ahmad.riyadi', '2025-10-21 09:26:55', NULL, NULL);
...
ALTER TABLE `jawaban_responden`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_jawaban_responden_responden` (`responden_id`),
  ADD KEY `fk_jawaban_responden_kuesioner` (`kuesioner_id`),
  ADD KEY `fk_jawaban_responden_opsi` (`opsi_jawaban_id`);

-- Indexes for table `kuesioner`
ALTER TABLE `kuesioner`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_kuesioner_survei` (`survei_id`);

-- Indexes for table `opsi_jawaban`
ALTER TABLE `opsi_jawaban`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_opsi_jawaban_kuesioner` (`kuesioner_id`);
...
ALTER TABLE `regencies`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code` (`code`),
  ADD KEY `fk_regencies_provinces` (`province_code`);

-- Indexes for table `respondens`
ALTER TABLE `respondens`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_respondens_pendidikan` (`pendidikan_id`),
  ADD KEY `fk_respondens_pekerjaan` (`pekerjaan_id`),
  ADD KEY `fk_respondens_penghasilan` (`penghasilan_id`),
  ADD KEY `fk_respondens_provinces` (`provinces_id`),
  ADD KEY `fk_respondens_regencies` (`regencies_id`);
...
ALTER TABLE `survei_peserta`
  ...
  ADD KEY `fk_survei_peserta_responden` (`responden_id`);
...
ALTER TABLE `jawaban_responden`
  ADD CONSTRAINT `fk_jawaban_responden_kuesioner` FOREIGN KEY (`kuesioner_id`) REFERENCES `kuesioner` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_jawaban_responden_opsi` FOREIGN KEY (`opsi_jawaban_id`) REFERENCES `opsi_jawaban` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_jawaban_responden_responden` FOREIGN KEY (`responden_id`) REFERENCES `respondens` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- Constraints for table `kuesioner`
ALTER TABLE `kuesioner`
  ADD CONSTRAINT `fk_kuesioner_survei` FOREIGN KEY (`survei_id`) REFERENCES `survei` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- Constraints for table `opsi_jawaban`
ALTER TABLE `opsi_jawaban`
  ADD CONSTRAINT `fk_opsi_jawaban_kuesioner` FOREIGN KEY (`kuesioner_id`) REFERENCES `kuesioner` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- Constraints for table `regencies`
ALTER TABLE `regencies`
  ADD CONSTRAINT `fk_regencies_provinces` FOREIGN KEY (`province_code`) REFERENCES `provinces` (`code`) ON DELETE CASCADE ON UPDATE CASCADE;

-- Constraints for table `respondens`
ALTER TABLE `respondens`
  ADD CONSTRAINT `fk_respondens_pekerjaan` FOREIGN KEY (`pekerjaan_id`) REFERENCES `pekerjaan` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_respondens_pendidikan` FOREIGN KEY (`pendidikan_id`) REFERENCES `pendidikan` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_respondens_penghasilan` FOREIGN KEY (`penghasilan_id`) REFERENCES `penghasilan` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_respondens_provinces` FOREIGN KEY (`provinces_id`) REFERENCES `provinces` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_respondens_regencies` FOREIGN KEY (`regencies_id`) REFERENCES `regencies` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- Constraints for table `survei_peserta`
ALTER TABLE `survei_peserta`
  ADD CONSTRAINT `fk_survei_peserta_responden` FOREIGN KEY (`responden_id`) REFERENCES `respondens` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_survei_peserta_survei` FOREIGN KEY (`survei_id`) REFERENCES `survei` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;